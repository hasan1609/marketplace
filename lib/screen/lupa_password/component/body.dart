...
import 'package:marketplace/component/form_error.dart';
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              Text(
                "harap masukkan Email yang terhubung dengan akun anda",
    ...
    return Form(
      ...
      child: Column(
        children: [
          ...
          SizedBox(height: getPropertionateScreenWidth(30)),
